 ...
 *
 */
public class MyOscilloscope implements AudioProcessor {
	public static interface OscilloscopeEventHandler{
		 ...
		 */
		void handleEvent(float[] data, multiaudiorecorder.AudioEvent event);
	}
        
	float[] dataBuffer;
	private final OscilloscopeEventHandler handler;
	public MyOscilloscope(OscilloscopeEventHandler handler){
		this.handler = handler;
	}
	
	@Override
	public boolean process(multiaudiorecorder.AudioEvent audioEvent) {
